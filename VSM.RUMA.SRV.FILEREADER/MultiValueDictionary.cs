...
{
    public delegate void MultiValueDictionaryChanged(object sender, NotifyCollectionChangedEventArgs ValueAdded);
    public delegate void MultiValueDictionaryKeyAdded(object sender, CollectionChangeEventArgs KeyAdded);

...
{
    public class Win32Anilist : Win32
    {

        [ThreadStatic]
        private static Win32Anilist singleton;

        public static Win32Anilist Init()
        {
            if (singleton == null)
            {
                singleton = new Win32Anilist();
            }
            return singleton;
        }
        ...
        ///////////////////////////////////////////////////
        /*
         function lst_AB_OverzichtDiertelling(
        ...
        public int call_lst_AB_OverzichtDiertelling(int pProgID, int pProgramID, int pSoortBestand,
        ...
        {
            LockObject padlock;
            lst_AB_OverzichtDiertelling handle = (lst_AB_OverzichtDiertelling)ExecuteProcedureDLLStack(typeof(lst_AB_OverzichtDiertelling), "lst_AB_OverzichtDiertelling", GetLockList("ANILIST.DLL"), out padlock);
            int tmp;
            try
            {
        ...
        delegate int lst_AB_OverzichtDiertelling(int pProgID, int pProgramID, int pSoortBestand,
                        string pUbnnr, string pHostName, string pUserName, string pPassword, string pBestand, string pLog,
                        pCallback ReadDataProc,
                        int pSoort,
                        DateTime pBeginDatum, DateTime pEindDatum);
